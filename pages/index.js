      ...
      <section className='bg-bookmark-white py-20'>
        <div className='container'>
          ...
          <div className='flex flex-col sm:w-3/4 lg:w-5/12 mt-12 mx-auto'>
            <article className='mt-5 border-b pb-7'>
              <div className='flex items-center  '>
                ...
                <i
                  ...
                  className={
                    showFaq
                      ? 'text-bookmark-purple fas fa-chevron-up '
                      : 'text-bookmark-purple fas fa-chevron-down '
                  }
                ></i>
              </div>
              <p className={showFaq ? 'mt-4 block' : 'mt-4 hidden'}>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Autem,
                ducimus voluptate officia quam ipsa sunt saepe. Aspernatur eos
                quas accusamus velit ducimus atque dolor facilis, fugit error
                laboriosam eligendi molestias.
              </p>
            </article>
